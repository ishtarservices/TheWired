    ...
    <div>
          ...
          return (
            <label
              ...
              className={`flex cursor-pointer items-center gap-2 rounded-md px-3 py-1.5 text-sm transition-colors ${
                value === opt.value ? "bg-pulse/8 text-heading" : "text-soft hover:bg-surface"
              }`}
            >
              <input
                type="radio"
      ...
      {value === "space" && (
        <select
          ...
          className="mt-2 w-full rounded-xl border border-edge bg-field px-3 py-1.5 text-sm text-heading outline-none focus:border-pulse/30"
        >
