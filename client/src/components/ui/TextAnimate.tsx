...
function TextAnimateBase({
  ...
  const finalVariants = variants
    ...
    : animation
      ? {
          container: {
            ...animationPresets[animation].container,
            show: {
              ...animationPresets[animation].container.show,
              transition: {
                delayChildren: delay,
                staggerChildren: duration / segments.length,
              },
            ...
            exit: {
              ...animationPresets[animation].container.exit,
              transition: {
                staggerChildren: duration / segments.length,
                staggerDirection: -1,
              },
          ...
          item: animationPresets[animation].item,
        }
